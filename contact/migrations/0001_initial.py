# Generated by Django 5.0 on 2024-03-25 06:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phones', wagtail.fields.StreamField([('phone', wagtail.blocks.CharBlock(label='Phone', max_length=20, required=False))])),
                ('emails', wagtail.fields.StreamField([('email', wagtail.blocks.CharBlock(label='Email', max_length=100, required=False))])),
                ('addresses', wagtail.fields.StreamField([('address', wagtail.blocks.CharBlock(label='Address', max_length=100, required=False))])),
            ],
            options={
